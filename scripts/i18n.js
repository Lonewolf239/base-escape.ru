const translations = {
    ru: {
        ...
        err_403_desc:
            "У вас нет прав для просмотра этой страницы.<br>Если вы считаете, что это ошибка, свяжитесь с администратором.",

        title_404: "Lonewolf239 | Страница не найдена",
        err_404_title: "Страница не найдена",
        err_404_desc:
            "Запрашиваемая страница не существует или была перемещена.<br>Проверьте правильность адреса или вернитесь на главную.",

        title_503: "Lonewolf239 | Сервис недоступен",
        err_503_title: "Сервис временно недоступен",
        err_503_desc:
            "Ведутся технические работы. Попробуйте зайти позже.<br>Приносим извинения за временные неудобства.",
    ...
    en: {
        ...
        err_403_desc:
            "You do not have permission to view this page.<br>If you believe this is an error, please contact the administrator.",

        title_404: "Lonewolf239 | Page Not Found",
        err_404_title: "Page Not Found",
        err_404_desc:
            "The requested page does not exist or has been moved.<br>Check the URL or return to the homepage.",

        title_503: "Lonewolf239 | Service Unavailable",
        err_503_title: "Service Temporarily Unavailable",
        err_503_desc:
            "Maintenance is currently underway. Please try again later.<br>We apologize for the temporary inconvenience.",
    ...
    de: {
        ...
        err_403_desc:
            "Sie haben keine Berechtigung, diese Seite anzuzeigen.<br>Wenn Sie glauben, dass dies ein Fehler ist, wenden Sie sich bitte an den Administrator.",

        title_404: "Lonewolf239 | Seite nicht gefunden",
        err_404_title: "Seite nicht gefunden",
        err_404_desc:
            "Die angeforderte Seite existiert nicht oder wurde verschoben.<br>Überprüfen Sie die URL oder kehren Sie zur Startseite zurück.",

        title_503: "Lonewolf239 | Dienst nicht verfügbar",
        err_503_title: "Dienst vorübergehend nicht verfügbar",
        err_503_desc:
            "Es werden Wartungsarbeiten durchgeführt. Bitte versuchen Sie es später erneut.<br>Wir entschuldigen uns für die vorübergehenden Unannehmlichkeiten.",
